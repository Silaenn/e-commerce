...
const Footer = () => {
  return (
    <footer className="bg-white text-gray-900 mt-20 sm:mt-32 border-t border-green-100/50 w-full relative overflow-hidden">
      ...
      <div className="max-w-[1800px] mx-auto px-5 sm:px-8 md:px-12 py-12 sm:py-20 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-16">
            ...
            <ul className="space-y-4 sm:space-y-6 text-sm text-gray-600 font-bold">
              {[
                ...
                <li key={i} className="flex items-center gap-3 sm:gap-4 group cursor-pointer">
                  <div className="h-10 w-10 rounded-xl bg-green-50 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors duration-300 shrink-0">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex bg-gray-50 rounded-2xl p-2 pl-5 border border-transparent focus-within:border-primary/20 focus-within:bg-white transition-all shadow-inner">
              ...
              />
              <button className="bg-primary text-white p-3 sm:p-4 rounded-xl hover:bg-green-700 transition-all shadow-lg shadow-green-900/10 active:scale-95">
        ...
        <div className="border-t border-gray-100 mt-10 sm:mt-20 pt-6 sm:pt-10 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-6">
      ...
      <div className="absolute bottom-0 right-0 w-40 h-40 sm:w-64 sm:h-64 bg-primary/5 blur-[100px] rounded-full -mr-20 -mb-20 sm:-mr-32 sm:-mb-32" />
    </footer>
  );
};
