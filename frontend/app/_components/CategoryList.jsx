      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        >
          <div className="space-y-2 sm:space-y-3">
            ...
            <h2 className="text-gray-900 font-extrabold text-3xl sm:text-4xl md:text-5xl tracking-tighter">
              Browse Categories
            </h2>
              ...
              <motion.div key={c.id || index} variants={itemVariants}>
                ...
                >
                  ...
                  <div className="text-center space-y-1">
                    <h2 className="text-gray-900 font-bold text-sm sm:text-base md:text-xl tracking-tight transition-colors group-hover:text-primary">
                      {c.name}
                    </h2>
