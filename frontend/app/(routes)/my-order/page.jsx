                ...
                <CollapsibleTrigger asChild>
                  <div className="w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6 p-5 sm:p-8 md:p-10 bg-white border border-gray-100 rounded-[2rem] sm:rounded-[2.5rem] hover:border-primary/20 hover:shadow-2xl hover:shadow-green-900/5 transition-all duration-500 cursor-pointer group-data-[state=open]:border-primary/20 group-data-[state=open]:shadow-xl">
                    <div className="flex items-center gap-5 sm:gap-8">
                      <div className="h-12 w-12 sm:h-16 sm:w-16 rounded-[1rem] sm:rounded-[1.2rem] bg-green-50 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors duration-500 shrink-0">
                    ...
                    <div className="flex items-center gap-4 sm:gap-6 md:gap-16 w-full sm:w-auto">
                      <div className="text-left space-y-1 flex-1 sm:w-40">
                      ...
                      <div className="space-y-1 flex flex-col items-center sm:w-32">
                        <p className="text-xs font-black text-gray-400 uppercase tracking-widest">Status</p>
                        <div className={`min-w-[90px] text-center py-2 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm
