  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-[1800px] mx-auto px-5 py-4 sm:px-8 sm:py-6 md:p-12">
        {isFetching ? (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-12 animate-pulse">
            <div className="lg:col-span-2 space-y-10">
               <div className="space-y-6">
                  <div className="h-14 w-full bg-gray-200 rounded-3xl" />
            ...
            <div className="lg:col-span-1">
               <div className="h-[400px] w-full bg-gray-200 rounded-[2.5rem]" />
            </div>
          </div>
        ) : (
